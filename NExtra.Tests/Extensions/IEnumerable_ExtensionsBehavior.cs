...
namespace NExtra.Tests.Extensions
{
    ...
    public class IEnumerable_ExtensionsBehavior
    {
        ...
        public void OrderBy_ShouldApplyToCollection()
        {
            ...
            var result = magazineSales.OrderBy("Key").ToList();
        ...
        public void OrderBy_ShouldOverrideLastOrderBy()
        {
            ...
            var result = magazineSales.OrderBy("Key").OrderBy("Value").ToList();
        ...
        {
            var original = magazineSales.ToList();
            var result = magazineSales.OrderByDescending("Key").ToList();
        ...
        {
            var original = magazineSales.ToList();
            var result = magazineSales.OrderByDescending("Key").OrderByDescending("Value").ToList();
        ...
        {
            var original = magazineSales.ToList();
            var result = magazineSales.OrderBy("Key").ThenBy("Value").ToList();
        ...
        {
            var original = magazineSales.ToList();
            var result = magazineSales.OrderByDescending("Key").ThenBy("Value").ToList();
        ...
        {
            var original = magazineSales.ToList();
            var result = magazineSales.OrderBy("Key").ThenByDescending("Value").ToList();
        ...
        {
            var original = magazineSales.ToList();
            var result = magazineSales.OrderByDescending("Key").ThenByDescending("Value").ToList();
