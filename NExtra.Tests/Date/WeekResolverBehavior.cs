...
namespace NExtra.Tests.Date
{
    ...
    public class WeekResolverBehavior
    {
        ...
        public void SetUp()
        {
            _resolver = new WeekResolver(CalendarWeekRule.FirstFourDayWeek, DayOfWeek.Monday);
        }
        ...
        {
            Assert.That(_resolver.GetFirstDateOfWeek(new DateTime(2009, 01, 01)), Is.EqualTo(new DateTime(2009, 01, 01)));
        }
        ...
        {
            Assert.That(_resolver.GetLastDateOfWeek(new DateTime(2008, 12, 31)), Is.EqualTo(new DateTime(2008, 12, 31)));
        }
        ...
        {
            Assert.That(_resolver.GetWeekNumber(new DateTime(2008, 12, 31)), Is.EqualTo(53));
        }
