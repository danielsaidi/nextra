...
namespace NExtra.Tests.Date
{
    ...
    public class Iso8601WeekResolverBehavior
    {
        ...
        public void SetUp()
        {
            resolver = new Iso8601WeekResolver();
        }
        ...
        {
            Assert.That(resolver.GetFirstDateOfWeek(new DateTime(2009, 01, 01)), Is.EqualTo(new DateTime(2008, 12, 29)));
        }
        ...
        {
            Assert.That(resolver.GetLastDateOfWeek(new DateTime(2008, 12, 31)), Is.EqualTo(new DateTime(2009, 01, 04)));
        }
        ...
        {
            Assert.That(resolver.GetWeekNumber(new DateTime(2008, 12, 31)), Is.EqualTo(1));
        }
