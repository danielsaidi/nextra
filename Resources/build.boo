...
target test:
   nunit(assemblies: test_assemblies, enableTeamCity: true, toolPath: "phantom/lib/nunit/nunit-console.exe", teamCityArgs: "v4.0 x86 NUnit-2.5.5")
